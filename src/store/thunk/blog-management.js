...
const allBlogsThunk = (navigate) => async (dispatch) => {
  ...
  try {
    const response = await fetch("https://gymbackenddddd-1.onrender.com/blog/allblogs", {
      method: "GET",
      credentials: "include",
    });
...
const userBlogDataThunk = () => async (dispatch) => {
  ...
  try {
    const response = await fetch("https://gymbackenddddd-1.onrender.com/blog/allblogsData", {
      method: "GET",
      credentials: "include",
    });
...
const postBlogThunk = (payload, navigate) => async (dispatch) => {
  ...
  try {
    const response = await fetch("https://gymbackenddddd-1.onrender.com/blog/new", {
      method: "POST",
...
const deleteBlogThunk = (blogId) => async (dispatch) => {
  try {
    const response = await fetch(`https://gymbackenddddd-1.onrender.com/blog/${blogId}`, {
      method: "DELETE",
      credentials: "include",
    });
