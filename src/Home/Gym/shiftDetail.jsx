...
const ShiftPage = ({ data, setShowShiftPage }) => {
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen w-full px-4 sm:px-6 py-6 sm:py-8 shadow-lg border border-gray-800">
      <div className="max-w-4xl mx-auto space-y-6">
        {/* Header Actions */}
        <div className="flex justify-between items-center">
          <button
            onClick={() => setShowShiftPage(null)}
            className="flex items-center gap-2 p-2 sm:p-3 bg-gray-700 rounded-full hover:bg-gray-600 transition-colors"
          >
          ...
          {!isEditing && (
            <div className="flex gap-3">
              <button
                ...
                className="flex items-center gap-2 bg-gray-700 hover:bg-indigo-600/30 px-3 py-2 rounded-lg transition text-sm border border-indigo-500/30"
              >
                <Edit size={14} />
                Edit
              </button>
              ...
              <button
                ...
                className="flex items-center gap-2 bg-gray-700 hover:bg-red-600/30 px-3 py-2 rounded-lg transition text-sm border border-red-500/30"
              >
                <Trash2 size={14} />
                Delete
              </button>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full px-3 py-2 border border-gray-600 bg-gray-800 text-white rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  >
                  ...
                  {data.joinedBy?.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                      {data.joinedBy.map((member, idx) => (
                        <div
                          key={idx}
                          className="flex items-center gap-3 bg-gray-800 p-3 rounded-xl border border-gray-700 hover:bg-gray-700 transition"
                        >
                          <img
