  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center p-6">
        <div className="text-center text-red-400 bg-red-900/30 border border-red-800 rounded-lg p-4">
          <p>{error}</p>
        </div>
      </div>
    );
  ...
  if (followersList.length === 0) {
    return (
      <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center p-6">
        ...
        <h1 className="text-xl text-gray-400 font-medium">No followers yet</h1>
